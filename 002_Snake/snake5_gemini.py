...
PRINT_EVERY                  = 500      # Print stats every N episodes
RENDER_GAME                  = True      # True: show the game window, False: no window

# Show the game window every Nth episode
RENDER_EVERY_EPISODE         = 6000      # (Set to 0 if you never want normal rendering)
...
class SnakeGame:
    ...
    def step(self, action):
        ...
        if not game_over:  # Add a small positive reward for survival
            reward += 0.01  # Adjust this value as needed
